...
class prm_generator_laststage(nn.Module):
    def __init__(self, in_channel=64, norm='in', num_cls=2):
...
class prm_fusion(nn.Module):
    def __init__(self, in_channel=64, basic_dim=16, norm='in', num_cls=2):
...
class region_fusion(nn.Module):
    def __init__(self, in_channel=64, num_cls=2):
