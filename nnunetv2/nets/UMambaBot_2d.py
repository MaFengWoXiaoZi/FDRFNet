...
def get_umamba_bot_2d_from_plans(
    ...
    """ # num_stages = self.configuraton_manager.network_arch_init_kwargs['n_stages]    dim = len(self.configuration_manager.network_arch_init_kwargs['kernel_sizes'][0])
    ...
    # n_conv_per_stage: self.configuration_manager.network_arch_init_kwargs['n_conv_per_stage']  n_conv_per_stage_decoder: self.configuration_manager.network_arch_init_kwargs['n_conv_per_stage_decoder'] 
